...
function updateMedicinePanel(button) {
    ...
    fetch(`/update-medicine/${medicineID}`)
        ...
        .then(data => {
            ...
            updateForm.addEventListener("submit", handleUpdateSubmissionMedicine);
        })
        .catch(error => console.error('Error:', error));
}

function handleUpdateSubmissionMedicine(event) {
